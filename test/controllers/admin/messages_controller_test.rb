...
class Admin::MessagesControllerTest < ActionController::TestCase
  ...
  test "should create admin_message" do
    assert_difference('Admin::Message.count') do
      post :create, admin_message: { abstract: @admin_message.abstract, author: @admin_message.author, category: @admin_message.category, content: @admin_message.content, tag: @admin_message.tag, title: @admin_message.title, user_id: @admin_message.user_id }
    end
  ...
  test "should update admin_message" do
    patch :update, id: @admin_message, admin_message: { abstract: @admin_message.abstract, author: @admin_message.author, category: @admin_message.category, content: @admin_message.content, tag: @admin_message.tag, title: @admin_message.title, user_id: @admin_message.user_id }
    assert_redirected_to admin_message_path(assigns(:admin_message))
  end
